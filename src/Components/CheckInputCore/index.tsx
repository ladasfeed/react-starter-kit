...
/** default | custom */
export function CheckInputBuilder<F extends checkboxBuilderType, T>(constructor: CheckboxCreatorType<T, F>) {
         ...
         <label className={cn(styles.container, props.className)}>
            ...
            {constructor?.customElement ? (
               ...
               <div className={styles.icon}>
                  {constructor.icons && React.createElement(
                     constructor.icons[props.inputType]?.checked,
                     {
